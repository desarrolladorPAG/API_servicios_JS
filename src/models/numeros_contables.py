...
class Numeros_contables(db.Model):
    ...
    usuario = db.relationship('Usuarios', back_populates="numeros_contables", uselist=False, single_parent=True)

    def __init__(self, id_numero_contable, servicio_id, sub_servicio_id, tipo_asignacion_id, usuario_id, numero_documento, fecha_emision, ruta_archivo, observacion):
