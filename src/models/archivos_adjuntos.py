...
class Archivos_adjuntos(db.Model):
    ...
    usuario = db.relationship('Usuarios', back_populates="archivos_adjuntos", uselist=False, single_parent=True)

    def __init__(self, id_archivo_adjunto, servicio_id, sub_servicio_id, tipo_adjunto_id, usuario_id, ruta_archivo):
